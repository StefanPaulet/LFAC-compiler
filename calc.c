...
{
  "$end", "error", "$undefined", "T_INT_NUMBER", "ID", "'-'", "'+'",
  "'*'", "'/'", "UMINUS", "'('", "')'", "'='", "$accept", "Start", "$@1",
  "Expression", "Declaration", YY_NULLPTR
};
#endif
...
{
      17,    10,    23,   -11,    21,   -11,    -1,   -11,   -11,   -11,
      -1,    -1,    12,   -11,     5,    -1,    -1,    -1,    -1,   -11,
       7,     7,   -11,   -11
};
...
{
      13,    14,     8,     9,    10,    20,    21,    22,    23,    11,
      15,    16,    17,    18,    17,    18,    19,    15,    16,    17,
      18,     1,     4,     5,     7
};

static const yytype_int8 yycheck[] =
{
      10,    11,     3,     4,     5,    15,    16,    17,    18,    10,
...
{
       0,     4,    14,    17,    12,     0,    15,     3,     3,     4,
       5,    10,    16,    16,    16,     5,     6,     7,     8,    11,
      16,    16,    16,    16
};
...
#line 100 "calc.y"
       { 
        int value = getVarValue ( (yyvsp[0].stringValue) );
        if ( value != -1 ) {
...
#line 1438 "calc.c"
  ...
  case 12:
#line 108 "calc.y"
                        { addTableEntry ( "int", (yyvsp[-2].stringValue) ); }
#line 1444 "calc.c"
    break;
